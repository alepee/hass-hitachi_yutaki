...
- **Breaking:** `power_consumption` sensor attribute renamed from `source` to `energy_source` (values changed from entity_id/`"gateway"` to `"external"`/`"gateway"`/`"calculated"`) (#273)
